...
async def predict(query: str, history: List[List[str]], model_id: str):
    ...
    chunk = ChatCompletionResponse(
        model=model_id, choices=[choice_data],
        object="chat.completion.chunk"
    )
    yield "{}".format(chunk.json(exclude_unset=True, ensure_ascii=False))
    yield '[DONE]'
...
if __name__ == "__main__":
    ...
    model_dict = {
        "4": "/home/huangml/ChatGLM2-6B/model",
        "8": "/home/huangml/ChatGLM2-6B/model",
        "16": "/home/huangml/ChatGLM2-6B/model",
    }

    model_name = model_dict.get(args.model_name, "/home/huangml/ChatGLM2-6B/model")
    # tuning
    ...
    model = AutoModel.from_pretrained(model_name, config=config, trust_remote_code=True).cuda()
